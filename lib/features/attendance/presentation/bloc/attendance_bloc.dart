...
class AttendanceBloc extends Bloc<AttendanceEvent, AttendanceState> {
  ...
  Future<void> _onLoadCurrentWeek(
    ...
    final config = configResult.fold((_) => const WorkScheduleConfig(), (c) => c);
    _config = config;
  ...
  Future<void> _onWeekSelected(
    ...
    final isCurrentWeek = !event.weekStart.isAfter(now) && !event.weekEnd.isBefore(now);

    await _loadWeek(emit, useLocalLogs: false, isCurrentWeek: isCurrentWeek);
  }
