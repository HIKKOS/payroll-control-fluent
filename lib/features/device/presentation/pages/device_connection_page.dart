                ...
                children: [
                  ...
                  Row(children: [
                    Container(
                      ...
                      child: const Icon(LucideIcons.fingerprintPattern,
                          size: 18, color: ShadNeutral.foreground),
                    ),
                  ...
                  ShadCard(
                    ...
                    child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Conectar dispositivo',
                              style: TextStyle(
                                  fontSize: 15,
                                  fontWeight: FontWeight.w600,
                                  color: ShadNeutral.foreground)),
                          ...
                          SizedBox(
                            ...
                            child: ShadPrimaryButton(
                              label: loading ? 'Conectando…' : 'Conectar',
                              icon: loading ? null : LucideIcons.plugZap,
                  ...
                  const Center(
                      child: Text(
                    'ControlID Flex · HTTP API',
                    style:
                        TextStyle(fontSize: 11, color: ShadNeutral.fgTertiary),
                  )),
                ],
              ),
            ),
